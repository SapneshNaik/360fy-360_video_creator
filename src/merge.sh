...
`ffmpeg -r $1 -i vid_files/frames/FY%06d.png -vf 'scale=trunc(iw/2)*2:trunc(ih/2)*2' -s $2 -c:v libx264 -profile:v high444 -refs 16  -preset ultrafast vid_files/video.mp4 -y`
