...
`ffmpeg -loglevel panic -r $1 -i ../temp_data/frames/FY%06d.png   -c:v libx264 -profile:v high444 -refs 16  -preset ultrafast ../temp_data/video_unscaled.mp4 -y`
...
#-crf 0
#backup
# `ffmpeg -loglevel panic -r $1 -i ../temp_data/frames/FY%06d.png -vf 'scale=trunc(iw/2)*2:trunc(ih/2)*2' -s $2 -c:v libx264 -profile:v high444 -refs 16  -preset ultrafast ../temp_data/video.mp4 -y`
